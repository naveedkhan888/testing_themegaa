...
class Lasa_Merlin_Elementor
{
    public function import_files_demo_1()
    {
        ...
        return array(
            array(
                'import_file_name'           => 'Demo Fashion 1',
                'home'                       => 'home',
    ...
    public function import_files_demo_2()
    {
        ...
        return array(
            array(
                'import_file_name'           => 'Demo Fashion 2',
                'home'                       => 'home',
                'import_file_url'          	 => $data_url,
                'import_widget_file_url'     => $widget_url,
                'import_redux'         => array(
    ...
    public function import_files_demo_7()
    {
        ...
        return array(
            array(
                'import_file_name'           => 'Demo Fashion 3',
                'home'                       => 'home',
                'import_file_url'          	 => $data_url,
                'import_widget_file_url'     => $widget_url,
                'import_redux'         => array(
    ...
    public function import_files_demo_8()
    {
        ...
        return array(
            array(
                'import_file_name'           => 'Demo Fashion 4',
                'home'                       => 'home',
                'import_file_url'          	 => $data_url,
                'import_widget_file_url'     => $widget_url,
                'import_redux'         => array(
    ...
    public function import_files_demo_3()
    {
        ...
        return array(
            array(
                'import_file_name'           => 'Demo Furniture 1',
                'home'                       => 'home',
                'import_file_url'          	 => $data_url,
                'import_widget_file_url'     => $widget_url,
                'import_redux'         => array(
    ...
    public function import_files_demo_4()
    {
        ...
        return array(
            array(
                'import_file_name'           => 'Demo Furniture 2',
                'home'                       => 'home',
                'import_file_url'          	 => $data_url,
                'import_widget_file_url'     => $widget_url,
                'import_redux'         => array(
    ...
    public function import_files_demo_5()
    {
        ...
        return array(
            array(
                'import_file_name'           => 'Demo Furniture 3',
                'home'                       => 'home',
                'import_file_url'            => $data_url,
                'import_widget_file_url'     => $widget_url,
                'import_redux'         => array(
    ...
    public function import_files_demo_6()
    {
        ...
        return array(
            array(
                'import_file_name'           => 'Demo Furniture 4',
                'home'                       => 'home',
                'import_file_url'            => $data_url,
                'import_widget_file_url'     => $widget_url,
                'import_redux'         => array(
