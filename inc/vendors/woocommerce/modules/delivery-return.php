...
if (! function_exists('themename_the_delivery_return')) {
    function themename_the_delivery_return($product_id)
    {
        ...
        $title = themename_xptheme_get_config('single_delivery_return_title');
        $icon = themename_xptheme_get_config('single_delivery_return_icon');
        
        wp_enqueue_script('jquery-magnific-popup');
        wp_enqueue_style('magnific-popup');
        ?>
        <li class="item xptheme-delivery-return">
            <a href="#xptheme-content-delivery-return" class="popup-button-open">
                <?php 
                    if( !empty($icon) ) {
            ...
            <div id="xptheme-content-delivery-return" class="xptheme-popup-content zoom-anim-dialog mfp-hide">
                <div class="content">
