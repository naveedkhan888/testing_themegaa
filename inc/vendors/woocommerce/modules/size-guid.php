...
if (! function_exists('themename_the_size_guide')) {
    function themename_the_size_guide($product_id)
    {
        ...
        $title = themename_xptheme_get_config('single_size_guide_title');
        $icon = themename_xptheme_get_config('single_size_guide_icon');
        
        wp_enqueue_script('jquery-magnific-popup');
        wp_enqueue_style('magnific-popup');
        ?>
        <li class="item xptheme-size-guide">
            <a href="#xptheme-content-size-guide" class="popup-button-open">
                <?php 
                    if( !empty($icon) ) {
            ...
            <div id="xptheme-content-size-guide" class="xptheme-popup-content xptheme-popup-size-guid zoom-anim-dialog mfp-hide">
                <div class="content">
                    <h3 class="xptheme-headling-popup"><?php esc_html_e('Size Guide', 'themename'); ?></h3>
