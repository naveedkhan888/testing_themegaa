...
<section id="main-container" class="main-content <?php echo esc_attr(apply_filters('lasa_tbay_blog_content_class', 'container')); ?>">
			...
			<div id="content" class="site-content single-post" role="main">
				<?php
					...
					while (have_posts()) : the_post();
						...
						if (lasa_tbay_get_config('show_blog_related', false)): ?>
